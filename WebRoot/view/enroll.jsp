              ...
              <span class="tishi"> ${re}</span>
  		      ...
  		      <tr>
  	              ...
  	              <td>
					  ...
					  <input type="checkbox" name="hobbys" value="2" id="" />音乐
					  <input type="checkbox" name="hobbys" value="3" id="" />学习
					  <input type="checkbox" name="hobbys" value="4" id="" />旅游
					  <input type="checkbox" name="hobbys" value="5" id="" />看书
  	              </td>
  		      </tr>
  		      <tr>
  	              <td>个人简介：</td>
